...
faq:
  - q: "Is YouTube worth it for a B2B company with no subscribers?"
    a: "The data suggests channel size does not determine how often a video is cited. In OtterlyAI's YouTube Citation Study 2026, 40.83% of cited videos had fewer than 1,000 views, and subscriber count showed virtually no correlation with citation frequency (r = −0.03). One important caveat: the dataset contains only videos that were already cited. It explains what drives citation frequency, not what makes a video eligible in the first place."
  - q: "What video length do AI systems cite most often?"
    a: "According to the same study, 94% of AI citations went to long-form videos rather than Shorts. The most frequently cited length was 10 to 20 minutes (32.1%), followed by 5 to 10 minutes (26.1%). If the goal is citability, that argues against short clips as the format of choice."
  - q: "Are short social clips pointless, then?"
    a: "No — they have a different job. A 30 to 60 second clip creates attention where your audience is scrolling and leads to the article that carries the full, citable answer. Its measure of success is reach and clicks through to the article, not citations in AI answers. That more readers indirectly produce more mentions is plausible, but it has not been measured — so we do not credit the format with it."
  - q: "Does ChatGPT use YouTube as a source?"
    a: "Far less than the Google surfaces do. OtterlyAI distributes the measured YouTube citations as follows: Perplexity 38.7%, Google AI Overviews 36.6%, Google AI Mode 19.6%, ChatGPT 4.4%, Copilot 0.5%, Gemini 0.2%. If being named in ChatGPT is your priority, video is not where you should start."
  - q: "Do we have to appear on camera ourselves?"
    a: "No. What counts for machine processing is what is said and written, not who is on screen. A screen recording with a spoken explanation delivers the same text layers as a studio production: title, description and transcript. What matters is the depth of the answer — and whether company and product names are actually spoken."
  - q: "Does YouTube replace the work on our own website?"
    a: "No. If AI crawlers cannot read your pages, the foundation for everything else is missing. In our model YouTube belongs to the second visibility tier — it only takes effect once the first one is in place. It also does not replace mentions on third-party sites: in Ahrefs' May 2025 study of Google AI Overviews, branded web mentions correlated at r = 0.664, backlinks at only r = 0.218."
---
...
<div class="blog-stat-grid not-prose">
  <div class="blog-stat-card">
    ...
    <span class="stat-label">of answers in the German Google AI Mode contain a YouTube link — the most frequent source</span>
    <span class="stat-source">SISTRIX, Top sources in AI Mode Germany, 27.10.2025</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">0.737</span>
    <span class="stat-label">correlation between YouTube mentions and being named in AI answers — higher than any other factor examined</span>
    <span class="stat-source">Ahrefs, 75,000 brands, 12.12.2025</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">41%</span>
    <span class="stat-label">of the YouTube videos cited by AI systems had fewer than 1,000 views</span>
...
A second reason for the strength of the signal lies in the models' own history. Ahrefs points to [reporting by the New York Times](https://www.nytimes.com/2024/04/06/technology/tech-giants-harvest-data-artificial-intelligence.html) that OpenAI trained GPT-4 on, among other things, more than a million hours of YouTube transcripts. These systems have not just discovered this material.
...
Alongside its widely quoted detail findings, [OtterlyAI's YouTube Citation Study 2026](https://otterly.ai/blog/youtube-ai-citation-study-2026/) also gives the base figure: **5.54%** of all observed citations came from social media and video platforms combined, and **31.8%** of those went to YouTube. That works out at roughly **1.8% of all AI citations** across six platforms.
...
1. **Question first.** Which three questions does your sales team hear in every second conversation? Those are the video topics — not the product launch nobody is searching for.
2. **Answer in full.** One topic, one video, as long as the question requires.
3. **Prepare it.** A chapter marker per sub-question, a thorough description, a reviewed transcript — check company and product names.
4. **Interlock them.** The video belongs on the page it fits, and the text belongs beneath the video. Each format supports the other, and the page gains dwell time.
5. **Measure.** The same eight buyer questions, every month, in the same systems. Without measurement, any statement about effect is an assertion.
