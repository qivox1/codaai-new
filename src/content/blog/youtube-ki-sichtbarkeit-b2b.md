...
faq:
  - q: "Lohnt sich YouTube für ein B2B-Unternehmen ohne Abonnenten?"
    a: "Die Daten sprechen dafür, dass die Kanalgröße nicht darüber entscheidet, wie oft ein Video zitiert wird. In der YouTube Citation Study 2026 von OtterlyAI hatten 40,83 Prozent der zitierten Videos weniger als 1.000 Aufrufe, und die Abonnentenzahl korrelierte mit der Zitierhäufigkeit praktisch nicht (r = −0,03). Wichtig zur Einordnung: Der Datensatz enthält ausschließlich bereits zitierte Videos. Er erklärt, wovon die Zitierhäufigkeit abhängt – nicht, wodurch ein Video überhaupt erst in Frage kommt."
  - q: "Welche Videolänge zitieren KI-Systeme am häufigsten?"
    a: "Laut derselben Untersuchung entfielen 94 Prozent der KI-Zitate auf Langform-Videos, nicht auf Shorts. Am häufigsten zitiert wurden Videos von 10 bis 20 Minuten (32,1 Prozent), gefolgt von 5 bis 10 Minuten (26,1 Prozent). Wenn das Ziel die Zitierfähigkeit ist, spricht das gegen kurze Clips als Format der Wahl."
  - q: "Sind kurze Social-Clips damit sinnlos?"
    a: "Nein, sie haben eine andere Aufgabe. Ein 30- bis 60-Sekunden-Clip erzeugt Aufmerksamkeit dort, wo die Zielgruppe scrollt, und führt auf den Fachbeitrag, der die vollständige und zitierfähige Antwort trägt. Sein Erfolgsmaß sind Reichweite und Klicks auf den Beitrag, nicht Zitate in KI-Antworten. Dass mehr Leser mittelbar zu mehr Erwähnungen führen, ist plausibel, aber nicht gemessen – und wir rechnen es dem Format deshalb auch nicht an."
  - q: "Nutzt ChatGPT YouTube als Quelle?"
    a: "Deutlich seltener als die Google-Oberflächen. OtterlyAI verteilt die gemessenen YouTube-Zitate so: Perplexity 38,7 Prozent, Google AI Overviews 36,6 Prozent, Google AI Mode 19,6 Prozent, ChatGPT 4,4 Prozent, Copilot 0,5 Prozent, Gemini 0,2 Prozent. Wer vor allem in ChatGPT genannt werden möchte, sollte deshalb nicht mit Video beginnen."
  - q: "Müssen wir für ein zitierfähiges Video selbst vor die Kamera?"
    a: "Nein. Für die maschinelle Verwertung zählt, was gesagt und geschrieben wird, nicht wer im Bild ist. Ein Bildschirmvideo mit gesprochener Erklärung liefert dieselben Textebenen wie eine Studioaufnahme: Titel, Beschreibung und Transkript. Was zählt, ist die inhaltliche Tiefe der Antwort – und ob Firmen- und Produktnamen im gesprochenen Text tatsächlich vorkommen."
  - q: "Ersetzt YouTube die Arbeit an der eigenen Website?"
    a: "Nein. Wenn KI-Crawler Ihre Seiten nicht lesen können, fehlt die Grundlage für alles Weitere. YouTube gehört in unserem Modell zur zweiten Visibility-Stufe – es wirkt erst, wenn die erste steht. Es ersetzt auch nicht die Erwähnung auf Drittseiten: In der Ahrefs-Untersuchung zu Google AI Overviews vom Mai 2025 korrelierten Markennennungen im Web mit r = 0,664, Backlinks dagegen nur mit r = 0,218."
---
...
<div class="blog-stat-grid not-prose">
  <div class="blog-stat-card">
    ...
    <span class="stat-label">der Antworten im deutschen Google AI Mode enthalten einen YouTube-Link – die häufigste Quelle</span>
    <span class="stat-source">SISTRIX, Top-Quellen im AI Mode Deutschland, 27.10.2025</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">0,737</span>
    <span class="stat-label">Korrelation der YouTube-Erwähnung mit der Nennung in KI-Antworten – höher als bei jedem anderen untersuchten Faktor</span>
    <span class="stat-source">Ahrefs, 75.000 Marken, 12.12.2025</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">41%</span>
    <span class="stat-label">der von KI zitierten YouTube-Videos hatten weniger als 1.000 Aufrufe</span>
    <span class="stat-source">OtterlyAI, YouTube Citation Study 2026</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">42,2%</span>
    <span class="stat-label">der AI-Mode-Antworten enthalten überhaupt eine Markenreferenz</span>
...
Ein zweiter Grund für die Stärke des Signals liegt in der Vorgeschichte der Modelle. Ahrefs verweist auf eine [Recherche der New York Times](https://www.nytimes.com/2024/04/06/technology/tech-giants-harvest-data-artificial-intelligence.html), wonach OpenAI GPT-4 unter anderem auf über einer Million Stunden YouTube-Transkriptionen trainiert hat. Die Systeme kennen dieses Material nicht erst seit gestern.
...
1. **Frage zuerst.** Welche drei Fragen stellt Ihr Vertrieb in jedem zweiten Gespräch? Das sind die Videothemen – nicht die Produktneuheit, nach der niemand sucht.
2. **Antwort vollständig.** Ein Thema, ein Video, so lang wie die Frage es verlangt.
3. **Aufbereiten.** Kapitelmarken je Teilfrage, ausführliche Beschreibung, Transkript durchsehen – Firmen- und Produktnamen prüfen.
4. **Verschränken.** Das Video gehört auf die Seite, zu der es inhaltlich passt, und der Text gehört unter das Video. Beide Formate belegen sich gegenseitig, und die Seite profitiert von der Verweildauer.
5. **Messen.** Dieselben acht Einkäuferfragen, jeden Monat, in denselben Systemen. Ohne Messung ist jede Aussage über Wirkung eine Behauptung.
