---
title: "Vergleichsartikel und Anbieter-Listen: Woher KI-Systeme ihre Empfehlungen nehmen"
...
faq:
  - q: "Woher nimmt ChatGPT seine Anbieter-Empfehlungen?"
    a: "Überwiegend aus Vergleichsartikeln und Ranglisten Dritter. In einer Untersuchung der Overthink Group vom Juli 2026 über rund 1.260 Kaufprompts in ChatGPT, Gemini, Perplexity und den Google AI Overviews trugen 70,8 Prozent aller Zitate ein Wort wie „beste“, „top“, „führend“ oder „beliebt“ im Titel der zitierten Seite. Wichtig zur Einordnung: Gemessen wurde das Title-Tag, nicht der Inhalt – und die Studie deckt nischige B2B-Software im US-Markt ab."
  - q: "Reicht ein Profil bei G2 oder Capterra, um in KI-Antworten zu erscheinen?"
    a: "Es hilft, trägt aber weniger als oft angenommen. In derselben Untersuchung entfielen auf alle bekannten Bewertungsportale zusammen – Gartner, G2, Capterra, TrustRadius – nur 8,6 Prozent der Zitate. Das G2-Netzwerk allein kam auf 8,0 Prozent, und davon stammte der weit überwiegende Teil aus Perplexity. Wer nur auf Portalprofile setzt, deckt einen kleinen Ausschnitt ab."
  - q: "Sollten wir eine eigene Vergleichsseite veröffentlichen, auf der wir selbst vorkommen?"
    a: "Nur, wenn sie ehrlich ist. Eine Liste, auf der das eigene Unternehmen zufällig gewinnt, ist für einen Leser in Sekunden als Werbung erkennbar und beschädigt das Vertrauen, um das es geht. Sinnvoll ist ein Vergleich mit offengelegten Kriterien, in dem auch Fälle benannt werden, in denen ein Wettbewerber die bessere Wahl ist. Auf der eigenen Seite haben Sie die größte Kontrolle darüber, was ein KI-System liest – das ist ein Argument für Sorgfalt, nicht gegen Ehrlichkeit."
  - q: "Warum wird Reddit bei B2B-Fragen so selten zitiert?"
    a: "Weil dort über nischige B2B-Software kaum diskutiert wird. In der Overthink-Untersuchung kam Reddit auf 1,4 Prozent der Zitate. Der Autor führt das darauf zurück, dass Reddit-Diskussionen entstehen, wenn Menschen ein Thema besprechen wollen – und Kategorien wie Software für Earned-Value-Management gehören selten dazu. In allgemeineren Themenfeldern sieht das anders aus."
  - q: "Gelten diese Zahlen auch für den deutschen Mittelstand?"
    a: "Nicht unmittelbar. Die Untersuchung deckt nischige B2B-Softwarekategorien im US-Markt ab, mit 150 bis 700 monatlichen Suchanfragen je Kategorie, und der Autor schreibt ausdrücklich, dass sich alle Zahlen auf sein Experiment beziehen. Die Richtung – Kaufprompts werden aus Listen Dritter beantwortet – deckt sich mit dem, was wir in unserer eigenen Erhebung über 449 deutsche Unternehmen gesehen haben. Die genauen Anteile sollten Sie für Ihre Kategorie messen, statt sie zu übernehmen."
---
...
<div class="blog-stat-grid not-prose">
  <div class="blog-stat-card">
    <span class="stat-value">70,8%</span>
    <span class="stat-label">aller Zitate bei B2B-Kaufprompts führen auf Seiten, deren Titel „beste", „top", „führend" oder „beliebt" enthält</span>
    <span class="stat-source">Overthink Group mit Amadora, rund 1.260 Prompts, 14.07.2026</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">8,6%</span>
    <span class="stat-label">entfallen auf alle bekannten Bewertungsportale zusammen – Gartner, G2, Capterra, TrustRadius</span>
    <span class="stat-source">dieselbe Untersuchung</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">51,6%</span>
    <span class="stat-label">der zitierten Seiten tragen die Jahreszahl im Titel</span>
    <span class="stat-source">dieselbe Untersuchung</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">1,4%</span>
    <span class="stat-label">Anteil von Reddit an den Zitaten bei nischigen B2B-Kaufprompts</span>
    <span class="stat-source">dieselbe Untersuchung</span>
  </div>
</div>
...
Wer die Begriffe dahinter nachschlagen möchte: Das [GEO-Glossar](/wissen/geo-glossar/) erklärt unter anderem [Grounding](/wissen/geo-glossar/grounding/) und [Query Fan-out](/wissen/geo-glossar/query-fan-out/) – die beiden Mechanismen, die erklären, warum eine einzelne Einkäuferfrage intern in mehrere Teilfragen zerfällt und an mehreren Stellen nach Belegen sucht.
