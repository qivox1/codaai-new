...
faq:
  - q: "Was bedeutet KI-Sichtbarkeit konkret?"
    a: "KI-Sichtbarkeit misst, ob und wie prominent ein Unternehmen in den Antworten generativer KI-Systeme wie ChatGPT, der Google KI-Übersicht, Perplexity oder Microsoft Copilot genannt wird. Anders als bei Google gibt es keine Ergebnisliste mit zehn Plätzen: Die KI nennt meist drei bis fünf Anbieter. Wer nicht dabei ist, existiert für diesen Rechercheschritt nicht."
  - q: "Wie prüfe ich, ob mein Unternehmen in ChatGPT sichtbar ist?"
    a: "Stellen Sie ChatGPT und der Google KI-Übersicht acht realistische Einkäuferfragen zu Ihrem Leistungsspektrum — ohne Ihren Firmennamen zu nennen. Notieren Sie pro Antwort: Werden Sie genannt? An welcher Stelle? Wer wird stattdessen empfohlen? Wird Ihre Website als Quelle zitiert? Nutzen Sie dabei einen abgemeldeten Browser oder ein temporäres Chatfenster, damit personalisierte Historie das Ergebnis nicht verfälscht."
  - q: "Schützen gute Google-Rankings vor KI-Unsichtbarkeit?"
    a: "Nein. In der CodaAI-Auswertung hatten 361 der 449 untersuchten Unternehmen mehr als 100 Top-10-Rankings bei Google. 34,9 % davon waren in ChatGPT trotzdem vollständig unsichtbar. Eine Ahrefs-Analyse von 75.000 Marken erklärt warum: Backlinks korrelieren nur mit 0,218 mit Nennungen in Google AI Overviews, Marken-Erwähnungen im Web dagegen mit 0,664."
  - q: "Was wirkt stärker für KI-Sichtbarkeit — Backlinks oder Erwähnungen?"
    a: "Erwähnungen. Ahrefs untersuchte 75.000 Marken und fand für Marken-Erwähnungen im Web eine Korrelation von 0,664 mit Nennungen in Google AI Overviews, für Backlinks nur 0,218 — rund dreimal schwächer. Die drei stärksten Faktoren liegen alle außerhalb der eigenen Website. Wichtig: Korrelation ist keine Kausalität, die Richtung ist aber über mehrere unabhängige Untersuchungen konsistent."
  - q: "Warum sehe ich KI-Sichtbarkeit nicht in Google Analytics?"
    a: "Weil ein großer Teil der Wirkung dort nicht ankommt. Laut YouGov beenden 21 % der Nutzer ihre Recherche mit der KI-Antwort, nur 23 % klicken auf die genannten Quellen. Wer nach dem Chat die Adresse direkt eintippt, erscheint als Direktzugriff. Belastbar messen lässt sich KI-Sichtbarkeit deshalb nur über wiederholbare Prompt-Tests und Server-Logs, nicht über Standard-Analytics."
  - q: "Wie lange dauert es, bis Maßnahmen zur KI-Sichtbarkeit wirken?"
    a: "Das hängt vom System ab. Die Google KI-Übersicht greift stark auf den Live-Index zu — hier können Content- und Technikmaßnahmen innerhalb von Wochen wirken. ChatGPT antwortet ohne aktivierte Websuche überwiegend aus Trainingsdaten; strukturelle Verbesserungen brauchen dort deutlich länger und laufen vor allem über Erwähnungen in Drittquellen."
  - q: "Was ist der Unterschied zwischen SEO und GEO?"
    a: "SEO (Search Engine Optimization) optimiert darauf, dass eine Seite in einer Ergebnisliste möglichst weit oben rankt. GEO (Generative Engine Optimization) optimiert darauf, dass Inhalte von KI-Systemen als Quelle für eine generierte Antwort verwendet und Unternehmen darin namentlich genannt werden. Der Begriff stammt aus einer Arbeit von Aggarwal et al. (KDD 2024), die zeigte, dass GEO-Methoden die Sichtbarkeit in generativen Antworten um bis zu 40 % erhöhen können."
---
...
<div class="blog-stat-grid not-prose">
  <div class="blog-stat-card">
    <span class="stat-value">54,7 %</span>
    <span class="stat-label">der Einkäuferfragen bleiben ohne Nennung des betroffenen Unternehmens</span>
    <span class="stat-source">CodaAI, „KI-Blindtest Mittelstand 2026", 3.592 Fragen / 449 Unternehmen</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">34,9 %</span>
    <span class="stat-label">der Unternehmen mit über 100 Top-10-Rankings sind in ChatGPT komplett unsichtbar</span>
    <span class="stat-source">CodaAI, „KI-Blindtest Mittelstand 2026", n = 361</span>
  </div>
  <div class="blog-stat-card">
    <span class="stat-value">3×</span>
    <span class="stat-label">stärker korrelieren Marken-Erwähnungen im Web mit KI-Nennungen als Backlinks (0,664 vs. 0,218)</span>
...
Die Richtung bestätigt auch [Gartner](https://www.gartner.com/en/newsroom/press-releases/2026-03-09-gartner-sales-survey-finds-67-percent-of-b2b-buyers-prefer-a-rep-free-experience): In einer Befragung von 646 B2B-Einkäufern bevorzugen 67 % einen Kaufprozess ohne Vertriebskontakt, und 45 % haben bei einem kürzlichen Kauf KI eingesetzt. Die Vorauswahl fällt also in einer Phase, in der Ihr Vertrieb gar nicht am Tisch sitzt.
...
| Befund | Wert | Basis |
|---|---|---|
| Fragen ohne Nennung des Unternehmens | 54,7 % | 1.965 von 3.592 Fragen |
| Unternehmen, bei denen namentlich Wettbewerber empfohlen werden | 46,8 % | 210 von 449 Unternehmen |
| Vollständig ersetzt (0 Nennungen bei 8 Fragen) | 12,9 % | 449 Unternehmen |
| Unsichtbar trotz starker Google-Rankings | 34,9 % | 361 Unternehmen mit > 100 Top-10-Rankings |
| Nicht genannt bei der eigenen Kategorie-Frage | 26 % | 449 Unternehmen |
| Eigene Website in keiner Antwort als Quelle zitiert | 39 % | 449 Unternehmen |
...
Bis vor Kurzem war das ein Befund ohne Erklärung. Inzwischen gibt es eine — und sie stammt aus der bislang größten öffentlichen Korrelationsanalyse zum Thema. [Ahrefs untersuchte 75.000 Marken](https://ahrefs.com/blog/ai-overview-brand-correlation/) und maß, welche Faktoren mit Nennungen in Google AI Overviews zusammenhängen (Spearman-Korrelation):
...
Hinzu kommt, dass „die KI-Suche" längst kein einzelner Kanal mehr ist. [Similarweb](https://www.similarweb.com/blog/marketing/geo/gen-ai-stats/) misst zwischen September 2024 und März 2026 ein Besuchswachstum von rund 84 % für ChatGPT — aber etwa das Neunfache für Gemini und rund +770 % für Claude. Eine Optimierung, die nur auf ein System zielt, ignoriert einen wachsenden Teil des Marktes.
...
**Erstens: KI-Antworten zitieren selten.** Laut [Similarweb](https://www.similarweb.com/blog/marketing/geo/gen-ai-stats/) enthielten im August 2025 nur 2,8 % aller ChatGPT-Antworten überhaupt Quellenangaben — im Januar 2025 waren es 0,6 %. Der Trend steigt deutlich, das absolute Niveau ist aber niedrig. Eine Nennung ohne Zitat erzeugt keinen Klick, aber sehr wohl eine Kaufentscheidung.
...
Wie diese Punkte im Detail umzusetzen sind, haben wir in einem eigenen Beitrag zu [AI-Crawler-Performance und GEO](https://www.codaai.ai/blog/ai-crawler-server-performance-geo/) beschrieben.

### 4. GEO-optimierter Content: Was KI-Systeme wirklich zitieren

Hier entscheidet sich, ob aus Abrufbarkeit eine Nennung wird — und dieser Hebel ist wissenschaftlich am besten belegt. In der ersten großen Arbeit zum Thema ([Aggarwal et al., „GEO: Generative Engine Optimization", KDD 2024](https://arxiv.org/abs/2311.09735), Princeton/Georgia Tech) wurden neun Optimierungsstrategien an einem eigens gebauten Benchmark getestet. Ergebnis: GEO-Methoden steigern die Sichtbarkeit in generativen Antworten um **bis zu 40 %** — und die stärksten Einzelhebel waren das Ergänzen von Statistiken, Zitaten und Quellenangaben. Reines Keyword-Stuffing gehörte zu den schwächsten Methoden.
